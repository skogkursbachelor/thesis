...
\newglossaryentry{rootzone}
{
    name=root zone,
    description={The root zone is the water held in the upper layer of the ground above the water table, within what's called the unsaturated zone \cite{senorge_terminology}}
}
...
\newacronym{ngu}{NGU}{Geological Survey of Norway (Norges Geologiske Undersøkelse)}
\newacronym{nve}{NVE}{The Norwegian Water Resources and Energy Directorate (Norges vassdrags- og energidirektorat)}
\newacronym{nibio}{NIBIO}{Norwegian Institute of Bioeconomy Research (Norsk institutt for bioøkonomi)}
\newacronym{met}{MET}{Norwegian Meteorological Institute (Meteorologisk institutt)}
...
\newacronym{ghrc}{GHRC}{GitHub Container Registry}
